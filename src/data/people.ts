...
export const people: Person[] = [
  {
    ...
    displayOrder: 0,
    verified: true,
    additionalInfo: 'Associate Editor, Water Research (2025–present)',
  },
  {
    id: 'minhyuk-jeung',
    name: 'Minhyuk Jeung',
  ...
  },
  {
    ...
    roleLabelKo: '석박사통합과정',
    period: '2022–present',
    photo: '/images/people/gwon-nahyeon.jpg',
    alumni: false,
    displayOrder: 22,
    verified: true,
  },
  ...
  // TODO: VERIFY - Add alumni and any additional current members from updated info
  {
    ...
    roleLabelKo: '석사과정',
    period: '2022–2024',
    photo: '/images/people/kim-sukyung.jpg',
    alumni: true,
    alumniInfo: 'Graduated 2024',
    displayOrder: 100,
    verified: false,
  },
];
