...
export const researchAreas: ResearchArea[] = [
  ...
  },
  {
    ...
    description: 'Creating digital replicas of environmental systems that integrate real-time monitoring data with simulation models for continuous assessment and scenario analysis. Building real-time water quality simulation toolboxes using machine learning and API integration.',
    descriptionKo: '실시간 모니터링 데이터와 시뮬레이션 모델을 통합하여 환경 시스템의 디지털 복제본을 구축합니다. 머신러닝과 API를 활용한 실시간 수질 시뮬레이션 툴박스를 개발합니다.',
